...
export const ProjectsQuery: any = gql`
  query ProjectsQuery( $limit: Int = 4,  $offset: Int = 0, $sector: [QueryArgument] = []  ) {
    entries(limit: $limit, offset: $offset, section: "projects", orderBy: "postDate DESC", sector: $sector) {
      id
      slug
      title
      postDate
