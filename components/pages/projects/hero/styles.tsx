...
const Container = styled(Cont)(css({
    ...
    [theme.mediaQueries.small]: {
        pr: "0px",
        pl: ['16px !important', '16px !important', '40px !important', '56px !important', '80px !important'],
    },
}));
...
const DetailsWrapper = styled('ul')(css({
    pt: 120,
    '> *:not(:last-child)': {
...
const Detail = styled('li')(css({
    display: 'flex',
    flexDirection: 'column',
    rowGap: '4px',

}))
export {LeftCol, RightCol, Pill, ContentWrapper, DetailsWrapper, Detail, Container}